	...
	public static void main(String[] args) {
		...
		AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
				...
				new GlobalConfig().setOutputDir(OUT_PATH)// 输出目录
						...
						.setXmlName("%sMapper").setDateType(DateType.ONLY_DATE).setIdType(IdType.ID_WORKER)
		...
		// .setControllerName("%sAction")
				...
				.setStrategy(
						...
						new StrategyConfig()
								...
								.setInclude(new String[] {"base_lump_preliminaries_item"}) // 需要生成的表
								// .setExclude(new String[]{"test"}) // 排除生成的表
								// 自定义实体，公共字段
								.setSuperEntityColumns(new String[]{"gmt_create","gmt_modified"})
